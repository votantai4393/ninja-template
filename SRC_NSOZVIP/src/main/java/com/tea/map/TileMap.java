...
public class TileMap {
    ...
    public boolean isNotPk() {
        return isLoiDai() || isChienTruong() || isDauTruong() || isFujukaSanctuary() || isCandyBattlefield()|| isLangRen();
    }
    ...
    public boolean isNotTeleport() {
        return isLoiDai() || isDauTruong() || isChienTruong() || isDungeo() || isDungeoClan() || isNhaThiDau()
                || isThatThuAi() || isFujukaSanctuary() || isCandyBattlefield() || isLangTruyenThuyet() || isupyen()|| isupluong() || isLangRen() ;
